...
$this->title = Yii::t('app', 'Select Language');
...
?>
	<div class="modal-body">
		<div class="row">
			<?= Html::radioList('language', Yii::$app->language, ['en' => Yii::t('app', 'English'), 'fr' => Yii::t('app', 'French (français)'), 'ar' => Yii::t('app', 'Arabic (العربية)')], 								
